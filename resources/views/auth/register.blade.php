<x-guest-layout>
    <span id="registration_back" class="font-bold ml-5 mt-5 absolute text-lg cursor-pointer text-gray-600 hover:text-gray-900" title="Go to Login"> << back</span>
    <x-jet-authentication-card>
        <x-slot name="logo">
          <img class="w-20 logo" src="{{ url('images/lightbulb.png') }}" alt="Quiz Portal"  title="Quiz Portal">
        </x-slot>
